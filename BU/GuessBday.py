...
"20 21 22 23\n" + \
"28 29 30 31"+\
"\nEnter 0 for No and1forYes:"
answer = eval(input(question3))
if answer == 1 :
 	day += 4

 # Prompt the user to answer the fourth question 40 question4 = "Is your birthday in Set4?\n" + \ 41 "8 91011\n"+\
...
if answer == 1:
 ...
 # Prompt the user to answer the fifth question 52 question5 = "Is your birthday in Set5?\n" + \ 53 "16 17 18 19\n"+ \
