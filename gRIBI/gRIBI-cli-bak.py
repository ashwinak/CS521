...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar 15 16:58:31 2019
...
def setup_connection(args):
    ...
    channel = implementations.insecure_channel(host=jet_host, port=jet_port)
    ...
    if noauth == False:
        ...
        gribi  = gribi_service_pb2.beta_create_gRIBI_stub(channel)

    else:
        gribi  = gribi_service_pb2.beta_create_gRIBI_stub(channel, metadata_transformer=client_metadata)
